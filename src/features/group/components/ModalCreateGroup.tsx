    ...
    <>
        <Dialog open={isOpen} onClose={closeModal} className="relative z-50">
            ...
            <DialogPanel className="relative max-w-lg space-y-4 border bg-white p-12 rounded-lg">
                <Heading level={2} className="font-bold">Crea un nuevo grupo</Heading>
                <Description className="text-gray-500">Organiza a tus grupos aquí. Crea o edita grupos escolares</Description>
                <FormCreateGroup />
