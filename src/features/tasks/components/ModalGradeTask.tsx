...
import FormGradeTask from './FormGradeTask';

export default function ModalGradeTask() {
            ...
            <Dialog open={isOpen} onClose={closeModal} className="relative z-50">
                <div className="fixed bg-black/60 inset-0 flex w-screen items-center justify-center p-4">
                    <DialogPanel className="relative max-w-lg space-y-4 border bg-white p-12 rounded-lg">
                        <Heading level={2} className="font-bold">Califica la tarea</Heading>
                        <Description className="text-gray-500">Aquí podrás calificar la tarea, recuerda que las calificaciones deben de ser justas y constructivas</Description>
                        <FormGradeTask />
