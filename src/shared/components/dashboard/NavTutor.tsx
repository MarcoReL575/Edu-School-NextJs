...
import { IconBell, IconBooks, IconClipboardText, IconHome, IconNotes, IconSpeakerphone, IconUserCheck } from "@tabler/icons-react"
...
const items = [
  ...
  { title: "Examenes", url: "examenes", icon: IconClipboardText },
